...
interface FahrerverwaltungDialogProps {
  ...
  defaultValues?: Fahrerverwaltung['fields'];
...
export function FahrerverwaltungDialog({ open, onClose, onSubmit, defaultValues, recordId, enablePhotoScan = true, enablePhotoLocation = true }: FahrerverwaltungDialogProps) {
  ...
  const FIELD_LABELS: Record<string, string> = {"vorname": "Vorname", "nachname": "Nachname", "telefon": "Telefonnummer", "email": "E-Mail-Adresse"};
