...
const PROXY_BASE = '';
const APP_ID = '6a46310ccdac4760b92c73cd';
...
export default function PublicFormFahrzeugerfassung() {
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-lg">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-foreground">Fahrzeugerfassung — Formular</h1>
        </div>
